...
urlpatterns = [
    path(
        "news-post/list/",
        views.ListNewsPostAPIView.as_view(),
        name="news_post_list",
    ),
    path(
        "news-post/create/",
        views.CreateNewsPostAPIView.as_view(),
        name="news_post_create",
    ),
    path(
        "news-post/update/<int:pk>/",
        views.UpdateNewsPostAPIView.as_view(),
        name="update_news_post",
    ),
    path(
        "news-post/delete/<int:pk>/",
        views.DeleteNewsPostAPIView.as_view(),
    ...
    path(
        "upvote-post/<int:pk>/",
        views.UpvotePostAPIView.as_view(),
        name="upvote_post",
    ),
]
